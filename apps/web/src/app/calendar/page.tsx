...
const READINESS_STYLE: Record<string, string> = {
  GREEN: 'border-l-4 border-blue-500 bg-blue-50',
  AMBER: 'border-l-4 border-blue-500 bg-blue-50',
  ...
  return (
    <AppShell>
      <div className="flex items-center justify-between">
        <h1 className="inline-block rounded-lg bg-brand-50 px-4 py-2 text-xl font-bold tracking-tight text-brand shadow-card">Departure Calendar</h1>
