  ...
  return (
    <AppShell>
      <div className="flex items-center justify-between">
        <h1 className="inline-block rounded-lg bg-white px-4 py-2 text-xl font-bold tracking-tight text-brand shadow-card">Suppliers</h1>
        {canManage && (
      ...
      {!canManage && <p className="mt-1 text-xs text-blue-100">Read-only — only Admin/Director can manage suppliers.</p>}
