...
export default function LmsCoursesPage() {
  ...
  return (
    <AppShell>
      ...
      <p className="mt-1 text-sm text-blue-100">Staff training courses — enroll, work through lessons, and take the quiz to earn a certificate.</p>
        ...
        {courses.map((c) => (
          ...
          >
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1.5 text-xs text-slate-400">
              {c.category && <span className="rounded-lg bg-brand-50 px-2 py-0.5 font-medium text-brand-700">{c.category}</span>}
