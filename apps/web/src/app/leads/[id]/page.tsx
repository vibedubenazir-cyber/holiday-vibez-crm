    ...
    <AppShell>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div>
          ...
          {showForm && (
            <form onSubmit={handleAddTraveler} className="mt-2 grid grid-cols-1 gap-2 rounded-xl border border-slate-200 bg-white dark:bg-slate-800 shadow-card transition-shadow hover:shadow-card-hover p-3">
