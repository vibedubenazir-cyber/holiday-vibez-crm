  ...
  return (
    <AppShell>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {QUICK_LINKS.map((l) => (
          <Link key={l.href} href={l.href} className="rounded-lg bg-white dark:bg-slate-800 px-3 py-1.5 text-sm font-medium text-brand shadow-card hover:shadow-card-hover">
            {l.label} →
          </Link>
        ))}
      </div>
